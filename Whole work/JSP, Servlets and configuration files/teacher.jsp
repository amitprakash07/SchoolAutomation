...
<form method="get" action="ask">
<tr><td align="center"><input type="submit" value="See Student Profile" name="link" id="link"></form>
<br>



<form method="get" action="ask">
<tr><td align="center"><input type="submit" value="See student result" name="link" id="link"></form>
<br>
